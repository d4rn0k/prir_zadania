...
> texData/$TIME_CHART_FILENAME.data
> texData/$SPEEDUP_CHART_FILENAME.data
...
do
	...
	do
		OUTPUT="$(mpirun -n $i ./$PROGRAM_NAME  $INPUT_FILE $OUTPUT_FILE)"
		echo $OUTPUT
	...
	echo $i $AVG_MS_TIME >> texData/$TIME_CHART_FILENAME.data
